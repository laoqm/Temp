...
public class DBTest {
    ...
    public static void main(String[] args) {
        ...
        //run("java:///test/db/user.new.xml#App", settings);
          run("java:///test/db/user.list.xml#App", settings);
        //run("java:///test/db/user.delete.xml#App", settings);
        //run("java:///test/db/user.query.xml#App", settings);
        //run("java:///test/db/user.update.xml#App", settings);
        //run("java:///test/db/user.delete.xml#App", settings);
    }
