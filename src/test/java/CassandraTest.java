...
public class CassandraTest {
	...
	public static void main(String[] args) {
		...
		settings.addSettings("java:///conf/settings.xml#App", null, Settings.getResourceFactory());
         try{
	    //  run("java:///test/cass/user.new.xml#App", settings);
		//  run("java:///test/cass/user.list.xml#App", settings);
	    //  run("java:///test/cass/user.delete.xml#App", settings);
		  run("java:///test/cass/user.query.xml#App", settings);
	    // run("java:///test/cass/user.update.xml#App", settings);
